...
<template>
  <nav
    class="bg-gray-50 w-64 md:w-20 lg:w-64 flex flex-col justify-between pb-20 border-r border-gray-200 h-full shadow-lg transition-all duration-300"
  >
    <div class="flex flex-col flex-grow justify-between h-full">
      <ul class="space-y-3 p-4">
        ...
        >
          <router-link
            :to="{ name: link.name }"
            class="flex items-center p-3 rounded-xl font-medium transition-colors duration-200"
      ...
      <div
        class="relative text-gray-600 bg-purple-100 w-full divide-gray-500 divide-solid p-4 mt-auto"
      >
        <router-link
        ...
        >
          <i
            class="fas fa-user-shield mr-3 text-xl text-purple-600 group-hover:text-purple-800 transition-colors duration-200"
          ></i>
