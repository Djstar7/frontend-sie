  ...
  <div class="min-h-screen bg-gray-50 flex flex-col items-center">
          ...
          >
            ...
            <p class="text-gray-500 mb-4 text-sm">
              ...
              <span class="font-medium text-purple-600">
                (Max: {{ doc.validation.maxSizeMB }} Mo, Formats:
                {{ doc.validation.fileTypes.map((t) => '.' + t).join(', ') }})
              </span>
            </p>
            ...
            <div class="mt-3 pt-2 border-t border-gray-100 text-sm">
              <p
                v-if="docErrors[doc.name]"
                class="text-red-600 font-medium flex items-center gap-2"
              >
                <i class="fas fa-times-circle"></i>
                Erreur: {{ docErrors[doc.name] }}
              </p>
              <p
                v-else-if="uploadedFiles[doc.name]"
                class="text-green-600 font-medium flex items-center gap-2"
              >
                <i class="fas fa-check-circle"></i>
                Fichier sélectionné:
                <span class="truncate max-w-[calc(100%-120px)] text-gray-700 italic">{{
    ...
    <div class="flex flex-col md:flex-row justify-center gap-6 mt-12 pt-6 border-t border-gray-200">
      ...
      <button
        ...
        :class="{
          'bg-purple-600 hover:bg-purple-700 shadow-purple-300/70 transform hover:scale-[1.01]':
            !isSubmitting,
